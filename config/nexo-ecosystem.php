...
// footer's ecosystem links. `current` marks this tool (nexoshort). URLs are
...
return [
    ...
    // identity. This repo is nexoshort, so it defaults to 'nexoshort'.
    'current' => env('NEXO_ECOSYSTEM_CURRENT', 'nexoshort'),
