{{-- Panel-host shell: the full Nexo chrome (header + app-switcher + footer) and
     ...
     legal, help). The short host (redirects/report/404) never renders this — it
     stays cookieless and asset-light, isolated from the ecosystem chrome.

     Slots: $head (extra <head> tags, e.g. the landing's SEO), $nav and $actions
     (passed through to the header). --}}
@props(['title' => null])
<!DOCTYPE html>
